...
2020년도 인천대학교 컴퓨터공학부 캡스톤디자인 졸업작품발표회 구술 참가팀 **WBPBP** 문서 저장소 📝
...
- [캡스톤디자인 시스템 설계서](formed/implementation.md)
- [캡스톤디자인 시험 결과서](formed/tests.md)
- [캡스톤디자인 개인별 수행내역](formed/team.md)
